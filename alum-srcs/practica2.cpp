...
static constexpr int numObjetos2 = 7 ;

static Objeto3D * objetos2[numObjetos2] = { nullptr};
...
void P2_Inicializar(  )
{
   ...
   objetos2[1] = new MallaRevol("../plys/peon.ply",50,true,true);
   objetos2[2] = new Cilindro(10, 20, false,true);
   objetos2[3] = new Esfera(10,50, false, true);
   objetos2[4] = new Cono(20,50, false, true);
   objetos2[5] = new Huevo(20,50, false, true);
   objetos2[6] = new Sombrero(20,50, false, true);
