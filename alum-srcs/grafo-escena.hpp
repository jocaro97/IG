...
class Potato : public NodoGrafoEscenaParam
{
  public:
    Potato();
};
...
class Brazo : public NodoGrafoEscena
{
  ...
  public:
    Brazo();
    Matriz4f* articulacionBrazo();
    Matriz4f* articulacionAnteBrazo();
};

class SombreroMov : public NodoGrafoEscena
{
private:
  int balanceo;
  int rotacion;
  public:
    SombreroMov();
    Matriz4f* balanceoSombrero();
    Matriz4f* rotacionSombrero();
};
...
//------------------------------------------------
// clases para el grafo escena de la P5
